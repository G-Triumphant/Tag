...
- (void)panGesAction:(UIPanGestureRecognizer *)panGes {
    ...
    CGFloat minX = _limitRect.origin.x - kBubblyHeight;
    
    CGFloat minY = 0;
    
    CGFloat maxX = _limitRect.size.width - kBubblyHeight + _limitRect.origin.x;
    
    CGFloat maxY = _limitRect.size.height - kBubblyHeight + _limitRect.origin.y;
